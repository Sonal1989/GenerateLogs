...
public class ExtentReportListener{
	...
	public void setExtent(){
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/Users/SKadam/workspace/GenerateLogs/test-output/ExtentReport.html", true);
	...
	public void titleTest1(){
		...
		String title = driver.getTitle();
		System.out.println(title);
		Assert.assertEquals(title,"Verisource1");
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		if(result.getStatus()==ITestResult.FAILURE){
			...
			String screenshotPath = ExtentReportListener.getScreenshot(driver, result.getName());
